...
// ΒΕΒΑΙΩΣΟΥ ΟΤΙ ΑΥΤΑ ΕΙΝΑΙ ΤΑ ΔΙΑΠΙΣΤΕΥΤΗΡΙΑ ΓΙΑ ΤΟ PRODUCTION ΠΕΡΙΒΑΛΛΟΝ ΣΟΥ ΣΤΟ VIVA WALLET
const VIVA_CLIENT_ID = process.env.VIVA_CLIENT_ID;
const VIVA_CLIENT_SECRET = process.env.VIVA_CLIENT_SECRET;

// Βασικά URLs για το Viva Wallet API (PRODUCTION περιβάλλον)
const VIVA_TOKEN_URL = 'https://accounts.vivapayments.com/connect/token'; // <-- URL για έκδοση token σε PRODUCTION
const VIVA_ORDERS_URL = 'https://api.vivapayments.com/checkout/v2/orders'; // <-- URL για δημιουργία παραγγελίας σε PRODUCTION

// Βάλε το σωστό URL βάση του περιβάλλοντος σου (PRODUCTION Frontend Checkout Page)
const VIVA_CHECKOUT_BASE_URL = 'https://www.vivapayments.com/web/checkout/'; // <-- URL της σελίδας πληρωμής σε PRODUCTION
